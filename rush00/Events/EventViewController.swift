...
class EventViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        desc.text = data?.desc
        date.text = formatDate(date: data!.beginAt)
        date.isUserInteractionEnabled = false
        bTim.text = formatTime(date: data!.beginAt)
        bTim.isUserInteractionEnabled = false
        eTim.text = formatTime(date: data!.endAt)
        eTim.isUserInteractionEnabled = false
        dura.text = "\(formatDuration(dateStart: data!.beginAt, dateEnd: data!.endAt)) hours"
